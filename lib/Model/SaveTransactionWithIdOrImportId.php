...
/**
 * SaveTransactionWithIdOrImportId Class Doc Comment
 *
 * @category Class
 * @package  YNAB
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SaveTransactionWithIdOrImportId implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SaveTransactionWithIdOrImportId';
     ...
     * Sets id
     *
     * @param string $id If specified, this id will be used to lookup a transaction by its `id` for the purpose of updating the transaction itself. If not specified, an `import_id` should be supplied.
     *
     * @return $this
     */
