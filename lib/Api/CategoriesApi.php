...
class CategoriesApi
{
     ...
     * Update a category
     *
     * @param  \YNAB\Model\PatchCategoryWrapper $body The category to update (required)
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param  string $category_id The id of the category (required)
     *
     * @throws \YNAB\ApiException on non-2xx response
     ...
     */
    public function updateCategory($body, $budget_id, $category_id)
    {
        list($response) = $this->updateCategoryWithHttpInfo($body, $budget_id, $category_id);
        return $response;
    }
     ...
     */
    public function updateCategoryWithHttpInfo($body, $budget_id, $category_id)
    {
        $returnType = '\YNAB\Model\SaveCategoryResponse';
        $request = $this->updateCategoryRequest($body, $budget_id, $category_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCategoryAsync($body, $budget_id, $category_id)
    {
        return $this->updateCategoryAsyncWithHttpInfo($body, $budget_id, $category_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCategoryAsyncWithHttpInfo($body, $budget_id, $category_id)
    {
        $returnType = '\YNAB\Model\SaveCategoryResponse';
        $request = $this->updateCategoryRequest($body, $budget_id, $category_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCategoryRequest($body, $budget_id, $category_id)
    {
        ...
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $budget_id when calling updateCategory'
            );
        }
        // verify the required parameter 'category_id' is set
        if ($category_id === null || (is_array($category_id) && count($category_id) === 0)) {
     ...
     *
     * @param  \YNAB\Model\PatchMonthCategoryWrapper $body The category to update.  Only &#x60;budgeted&#x60; amount can be updated and any other fields specified will be ignored. (required)
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param  \DateTime $month The budget month in ISO format (e.g. 2016-12-01) (\&quot;current\&quot; can also be used to specify the current calendar month (UTC)) (required)
     * @param  string $category_id The id of the category (required)
     *
     ...
     * @return \YNAB\Model\SaveCategoryResponse
     */
    public function updateMonthCategory($body, $budget_id, $month, $category_id)
    {
        list($response) = $this->updateMonthCategoryWithHttpInfo($body, $budget_id, $month, $category_id);
        return $response;
    }
     ...
     * @return array of \YNAB\Model\SaveCategoryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMonthCategoryWithHttpInfo($body, $budget_id, $month, $category_id)
    {
        $returnType = '\YNAB\Model\SaveCategoryResponse';
        $request = $this->updateMonthCategoryRequest($body, $budget_id, $month, $category_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMonthCategoryAsync($body, $budget_id, $month, $category_id)
    {
        return $this->updateMonthCategoryAsyncWithHttpInfo($body, $budget_id, $month, $category_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMonthCategoryAsyncWithHttpInfo($body, $budget_id, $month, $category_id)
    {
        $returnType = '\YNAB\Model\SaveCategoryResponse';
        $request = $this->updateMonthCategoryRequest($body, $budget_id, $month, $category_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMonthCategoryRequest($body, $budget_id, $month, $category_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateMonthCategory'
            );
        }
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
