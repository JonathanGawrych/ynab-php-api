...
class TransactionsApi
{
     ...
     */
    public function createTransaction($body, $budget_id)
    {
        list($response) = $this->createTransactionWithHttpInfo($body, $budget_id);
        return $response;
    }
     ...
     */
    public function createTransactionWithHttpInfo($body, $budget_id)
    {
        $returnType = '\YNAB\Model\SaveTransactionsResponse';
        $request = $this->createTransactionRequest($body, $budget_id);
     ...
     */
    public function createTransactionAsync($body, $budget_id)
    {
        return $this->createTransactionAsyncWithHttpInfo($body, $budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsyncWithHttpInfo($body, $budget_id)
    {
        $returnType = '\YNAB\Model\SaveTransactionsResponse';
        $request = $this->createTransactionRequest($body, $budget_id);
     ...
     */
    protected function createTransactionRequest($body, $budget_id)
    {
     ...
     */
    public function deleteTransaction($budget_id, $transaction_id)
    {
        list($response) = $this->deleteTransactionWithHttpInfo($budget_id, $transaction_id);
        return $response;
    }
     ...
     */
    public function deleteTransactionWithHttpInfo($budget_id, $transaction_id)
    {
        $returnType = '\YNAB\Model\TransactionResponse';
        $request = $this->deleteTransactionRequest($budget_id, $transaction_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTransactionAsync($budget_id, $transaction_id)
    {
        return $this->deleteTransactionAsyncWithHttpInfo($budget_id, $transaction_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTransactionAsyncWithHttpInfo($budget_id, $transaction_id)
    {
        $returnType = '\YNAB\Model\TransactionResponse';
        $request = $this->deleteTransactionRequest($budget_id, $transaction_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteTransactionRequest($budget_id, $transaction_id)
    {
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $budget_id when calling deleteTransaction'
            );
        }
    ...
    protected function getTransactionsRequest($budget_id, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        ...
        // query params
        if ($since_date !== null) {
            $queryParams['since_date'] = ObjectSerializer::toQueryValue($since_date, 'date');
        }
        // query params
        if ($type !== null) {
    ...
    /**
     * Operation getTransactionsByMonth
     *
     * List transactions in month, excluding any pending transactions
     *
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param  string $month The budget month in ISO format (e.g. 2016-12-01) (\&quot;current\&quot; can also be used to specify the current calendar month (UTC)) (required)
     * @param  \DateTime $since_date If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30). (optional)
     * @param  string $type If specified, only transactions of the specified type will be included. \&quot;uncategorized\&quot; and \&quot;unapproved\&quot; are currently supported. (optional)
     * @param  int $last_knowledge_of_server The starting server knowledge.  If provided, only entities that have changed since &#x60;last_knowledge_of_server&#x60; will be included. (optional)
     *
     ...
     * @return \YNAB\Model\HybridTransactionsResponse
     */
    public function getTransactionsByMonth($budget_id, $month, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        list($response) = $this->getTransactionsByMonthWithHttpInfo($budget_id, $month, $since_date, $type, $last_knowledge_of_server);
        return $response;
    }

    /**
     * Operation getTransactionsByMonthWithHttpInfo
     *
     * List transactions in month, excluding any pending transactions
     *
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     ...
     * @return array of \YNAB\Model\HybridTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionsByMonthWithHttpInfo($budget_id, $month, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        $returnType = '\YNAB\Model\HybridTransactionsResponse';
        $request = $this->getTransactionsByMonthRequest($budget_id, $month, $since_date, $type, $last_knowledge_of_server);
    ...
    /**
     * Operation getTransactionsByMonthAsync
     *
     * List transactions in month, excluding any pending transactions
     *
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsByMonthAsync($budget_id, $month, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        return $this->getTransactionsByMonthAsyncWithHttpInfo($budget_id, $month, $since_date, $type, $last_knowledge_of_server)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTransactionsByMonthAsyncWithHttpInfo
     *
     * List transactions in month, excluding any pending transactions
     *
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsByMonthAsyncWithHttpInfo($budget_id, $month, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        $returnType = '\YNAB\Model\HybridTransactionsResponse';
        $request = $this->getTransactionsByMonthRequest($budget_id, $month, $since_date, $type, $last_knowledge_of_server);
    ...
    /**
     * Create request for operation 'getTransactionsByMonth'
     *
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param  string $month The budget month in ISO format (e.g. 2016-12-01) (\&quot;current\&quot; can also be used to specify the current calendar month (UTC)) (required)
     * @param  \DateTime $since_date If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30). (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTransactionsByMonthRequest($budget_id, $month, $since_date = null, $type = null, $last_knowledge_of_server = null)
    {
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $budget_id when calling getTransactionsByMonth'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling getTransactionsByMonth'
            );
        }

        $resourcePath = '/budgets/{budget_id}/months/{month}/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \YNAB\Model\PutTransactionWrapper $body The transaction to update (required)
     * @param  string $budget_id The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param  string $transaction_id The id of the transaction (required)
     *
     * @throws \YNAB\ApiException on non-2xx response
     ...
     * @return \YNAB\Model\TransactionResponse
     */
    public function updateTransaction($body, $budget_id, $transaction_id)
    {
        list($response) = $this->updateTransactionWithHttpInfo($body, $budget_id, $transaction_id);
        return $response;
    }
     ...
     * @return array of \YNAB\Model\TransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTransactionWithHttpInfo($body, $budget_id, $transaction_id)
    {
        $returnType = '\YNAB\Model\TransactionResponse';
        $request = $this->updateTransactionRequest($body, $budget_id, $transaction_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsync($body, $budget_id, $transaction_id)
    {
        return $this->updateTransactionAsyncWithHttpInfo($body, $budget_id, $transaction_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsyncWithHttpInfo($body, $budget_id, $transaction_id)
    {
        $returnType = '\YNAB\Model\TransactionResponse';
        $request = $this->updateTransactionRequest($body, $budget_id, $transaction_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateTransactionRequest($body, $budget_id, $transaction_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \YNAB\Model\SaveTransactionsResponse
     */
    public function updateTransactions($body, $budget_id)
    {
        list($response) = $this->updateTransactionsWithHttpInfo($body, $budget_id);
        return $response;
    }
     ...
     * @return array of \YNAB\Model\SaveTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTransactionsWithHttpInfo($body, $budget_id)
    {
        $returnType = '\YNAB\Model\SaveTransactionsResponse';
        $request = $this->updateTransactionsRequest($body, $budget_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionsAsync($body, $budget_id)
    {
        return $this->updateTransactionsAsyncWithHttpInfo($body, $budget_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionsAsyncWithHttpInfo($body, $budget_id)
    {
        $returnType = '\YNAB\Model\SaveTransactionsResponse';
        $request = $this->updateTransactionsRequest($body, $budget_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateTransactionsRequest($body, $budget_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateTransactions'
            );
        }
        // verify the required parameter 'budget_id' is set
        if ($budget_id === null || (is_array($budget_id) && count($budget_id) === 0)) {
